...
//IMPORT EVERYTHING! Gives us access to functions required to use the robot
...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        CameraServer.getInstance().startAutomaticCapture(); //Used to get camera input from the SmartDashboard
    ...
    public void teleopInit() {
        ...
        Robot.grabberMech.canSeven.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative);
    ...
    public void teleopPeriodic() {
        double velocity = Robot.grabberMech.canSeven.getSelectedSensorVelocity(0);
