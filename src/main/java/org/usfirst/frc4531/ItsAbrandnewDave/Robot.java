...
public class Robot extends TimedRobot {
    ...
    public void teleopInit() {
		...
		Robot.climbFront.canEight.config_kF(Constants.kPIDLoopIdx, Constants.kGains.kF, Constants.kTimeoutMs);
		Robot.climbFront.canEight.config_kP(Constants.kPIDLoopIdx, Constants.kGains.kP, Constants.kTimeoutMs);
		Robot.climbFront.canEight.config_kI(Constants.kPIDLoopIdx, Constants.kGains.kI, Constants.kTimeoutMs);
        Robot.climbFront.canEight.config_kD(Constants.kPIDLoopIdx, Constants.kGains.kD, Constants.kTimeoutMs);
    ...
    public void teleopPeriodic() {
        ...
        if (!_lastButton1 && button1) {
            ...
            Robot.climbFront.canEight.set(ControlMode.Position, targetPositionRotations);
